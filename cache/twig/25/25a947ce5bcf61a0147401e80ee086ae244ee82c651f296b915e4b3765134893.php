...
class __TwigTemplate_e04001a5c9c5b847b5e39860ddf73b227964a1645cf85c4ee93e87fc6c7ac8d1 extends Twig_Template
{
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    ...
                    <li>{{ var_dump(work.media[image].url) }}<img src=\"{{ work.media.path }}\" alt=\"{{ work.title }}\"></li>
                {% endfor %}
            </ul>
        </div>
    </div>
