...
class __TwigTemplate_519d9cbe1df7f440473a251a55f015df3b1d38af78edf8671c98dbf98ab94f77 extends Twig_Template
{
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li><img src=\"{{ work.media.path }}\" alt=\"{{ work.title }}\"></li>
                {% endfor %}
            </ul>
        </div>
    </div>
