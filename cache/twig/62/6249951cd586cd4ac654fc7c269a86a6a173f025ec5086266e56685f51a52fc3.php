...
class __TwigTemplate_f5246776535909c8bf02e763a33ec6f29875cdc4979508f5222c68b457619540 extends Twig_Template
{
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                ";
        // line 71
        $context["works"] = $this->getAttribute($this->getAttribute($this->getAttribute(($context["taxonomylist"] ?? null), "get", [], "method"), "category", [], "array"), 0, [], "array");
        // line 72
        echo "                ";
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                {% set works = taxonomylist.get()['category'][0] %}
