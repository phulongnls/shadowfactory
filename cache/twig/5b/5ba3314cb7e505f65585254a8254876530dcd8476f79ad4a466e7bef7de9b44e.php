...
class __TwigTemplate_5d7c7b2896abfd1fcb9311142e044a32b05d462bdb99ead643b908201ee09ed3 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            ...
            // line 136
            echo "                    ";
            echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->vardumpFunc($this->getAttribute($this->getAttribute($context["work"], "metadata", []), "classall", [], "array"));
            echo "
                    <img src=\"";
            // line 137
        ...
        <div class=\"grid-item\">
            <div class=\"item row1 col2\">
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    ...
                    {{ vardump(work.metadata['classall']) }}
