...
class __TwigTemplate_f059781b9941472f0f01da346845fc29151f73b049fbd69d363382275dc530b8 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            ...
            echo " ";
            echo $this->getAttribute($this->getAttribute($context["work"], "taxonomy", []), "category", [], "array");
            echo "\">
                    <img src=\"";
            // line 143
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            ...
            {% for work in taxonomy.findTaxonomy({'category':listWorks}).order('folder','asc') %}
                ...
                {% endif %}
                <div class=\"item {{ classSize }} {{work.taxonomy['category']}}\">
