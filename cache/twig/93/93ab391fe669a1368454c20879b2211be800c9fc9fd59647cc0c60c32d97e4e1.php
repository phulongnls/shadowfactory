...
class __TwigTemplate_337240e95a6831f028a493a3945a69b3802835cffbae3e6247ce6c29c291b57d extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            ...
            // line 136
            echo "                    ";
            echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->vardumpFunc($this->getAttribute($this->getAttribute($this->getAttribute($context["work"], "metadata", []), "classall", [], "array"), "content", [], "array"));
            echo "
                    <img src=\"";
            // line 137
        ...
        <div class=\"grid-item\">
            <div class=\"item row1 col2\">
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    ...
                    {{ vardump(work.metadata['classall']['content']) }}
