...
class __TwigTemplate_f6522be81bf663ddfc8d09ad53ecdb54b75100cca6946a17c601ed2dc26b78d0 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            // line 77
            echo "                    <li>";
            echo var_dump($this->getAttribute($this->getAttribute($this->getAttribute($context["work"], "media", []), $this->getAttribute(($context["item"] ?? null), "img", []), [], "array"), "url", []));
            echo "<img src=\"";
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li>{{ var_dump(work.media[item.img].url) }}<img src=\"{{ work.media.path }}\" alt=\"{{ work.title }}\"></li>
                {% endfor %}
            </ul>
        </div>
    </div>
