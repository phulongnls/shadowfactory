...
class __TwigTemplate_f10d1f069c89214eb0a738e0401498cea68a88c5a1f500b98a5e757ddf67e94d extends Twig_Template
{
    ...
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            ...
            if ($this->getAttribute($this->getAttribute($this->getAttribute($context["work"], "metadata", []), "classtype", [], "array"), "content", [], "array")) {
                // line 136
                echo "                    ";
                echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->vardumpFunc($this->getAttribute($this->getAttribute($this->getAttribute($context["work"], "metadata", []), "classtype", [], "array"), "content", [], "array"));
                echo "
                    ";
                // line 137
                $context["classSize"] = $this->getAttribute($this->getAttribute($this->getAttribute($context["work"], "metadata", []), "classtype", [], "array"), "content", [], "array");
                // line 138
                echo "                    }
                ";
            } elseif ($this->getAttribute($this->getAttribute($this->getAttribute(            // line 139
$context["work"], "metadata", []), "classall", [], "array"), "content", [], "array")) {
                // line 140
                echo "                    ";
    ...
    {
        return array (  222 => 149,  213 => 146,  207 => 145,  202 => 144,  199 => 143,  196 => 142,  193 => 141,  190 => 140,  188 => 139,  185 => 138,  183 => 137,  178 => 136,  175 => 135,  172 => 134,  167 => 133,  161 => 132,  158 => 131,  153 => 130,  150 => 129,  148 => 128,  19 => 1,);
    }
        ...
        <div class=\"grid-item\">
            ...
            {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                ...
                {% if (work.metadata['classtype']['content']) %}
                    {{ vardump(work.metadata['classtype']['content']) }}
                    {% set classSize = work.metadata['classtype']['content'] %}
                    }
                {% elseif (work.metadata['classall']['content']) %}
