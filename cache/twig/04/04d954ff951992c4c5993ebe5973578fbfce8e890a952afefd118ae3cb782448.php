...
class __TwigTemplate_1f2cf36d13b71938553da903ca7ddc2db0317fd37299a7b525dce0ce838a32d7 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            ...
            // line 136
            echo "                    ";
            echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->vardumpFunc($this->getAttribute($this->getAttribute($context["work"], "metadate", []), "classAll", [], "array"));
            echo "
                    <img src=\"";
            // line 137
        ...
        <div class=\"grid-item\">
            <div class=\"item row1 col2\">
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    ...
                    {{ vardump(work.metadate['classAll']) }}
