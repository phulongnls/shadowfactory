...
class __TwigTemplate_bbcc421926efd8a051894915d2fd46e7f87ec7e2d9f8ed20d462940e30d79b85 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            // line 77
            echo "                    <li>";
            echo var_dump($this->getAttribute($context["work"], "media_order", []));
            echo "</li>
                ";
        }
        $_parent = $context['_parent'];
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li>{{ var_dump(work.media_order) }}</li>
                {% endfor %}
            </ul>
        </div>
    </div>
