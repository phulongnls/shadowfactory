...
class __TwigTemplate_a766faeceb60288b2f628703fc55f5e00e6fb7be97fafc3195ca95ffca08692c extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            // line 77
            echo "                    <li>";
            echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->vardumpFunc($this->getAttribute($this->getAttribute($context["work"], "media", []), "image", []));
            echo "</li>
                    <li>";
            // line 78
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li>{{ vardump(work.media.image) }}</li>
