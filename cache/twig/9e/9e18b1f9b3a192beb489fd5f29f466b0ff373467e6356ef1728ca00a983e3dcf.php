...
class __TwigTemplate_f04a47c6dde7932da9e0674e6e2767ef33d5efb4b275dde0ecd40eefed53aa30 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                ";
        // line 71
        $context["works"] = $this->getAttribute($this->getAttribute($this->getAttribute(($context["taxonomylist"] ?? null), "get", [], "method"), "category", [], "array"), 1, [], "array");
        // line 72
        echo "                ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["works"] ?? null));
        foreach ($context['_seq'] as $context["item"] => $context["key"]) {
            // line 73
            echo "                    ";
            echo $context["item"];
            echo "
        ...
        unset($context['_seq'], $context['_iterated'], $context['item'], $context['key'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 75
        echo "                ";
        echo var_dump(($context["works"] ?? null));
        echo "
                ";
        // line 76
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["taxonomy"] ?? null), "findTaxonomy", [0 => ["category" => ($context["works"] ?? null)]], "method"));
    ...
    {
        return array (  125 => 79,  116 => 77,  112 => 76,  107 => 75,  98 => 73,  93 => 72,  91 => 71,  19 => 1,);
    }
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                {% set works = taxonomylist.get()['category'][1] %}
                {% for item, key in works %}
                    {{ item }}
                {% endfor %}
                {{ var_dump(works) }}
                {% for work in taxonomy.findTaxonomy({'category':works}) %}
                    <li>{{ work.title }}</li>
                {% endfor %}
            </ul>
        </div>
