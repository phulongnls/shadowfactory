...
class __TwigTemplate_bf7918d26e7169f6d26f98ddfd9e66d66d2815b20e3799f1ae423a5e812f2d0a extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            ...
            echo "<img src=\"";
            echo $this->getAttribute($context["work"], "media", []);
            echo "\" alt=\"";
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li>{{ var_dump(work.media.path) }}<img src=\"{{ work.media }}\" alt=\"{{ work.title }}\"></li>
                {% endfor %}
            </ul>
        </div>
    </div>
