...
class __TwigTemplate_3c4034e90207cdd3ec295299d7c12be3d9771ab0e7dfdf93eabf05551a3fb96e extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["taxonomy"] ?? null), "findTaxonomy", [0 => ["category" => [0 => "AR/VR"]]], "method"));
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for post in taxonomy.findTaxonomy({'category': ['AR/VR']}) %}
                    <li>{{ post.title }}</li>
                {% endfor %}
            </ul>
        </div>
