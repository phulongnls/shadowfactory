...
class __TwigTemplate_fbd10118f26b3041e019c5acba937ff29837d05e3f43154b426f74facea6fb62 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            // line 77
            echo "                    <li>";
            echo var_dump($this->getAttribute($this->getAttribute($this->getAttribute($context["work"], "media", []), "images", []), "format", []));
            echo "<img src=\"";
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li>{{ var_dump(work.media.images.format) }}<img src=\"{{ work.media.path }}\" alt=\"{{ work.title }}\"></li>
                {% endfor %}
            </ul>
        </div>
    </div>
