...
class __TwigTemplate_6b06f8377815626abc10ee504ab886e67b1c8603fb893170de719b10f91c7949 extends Twig_Template
{
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                ";
        // line 71
        echo var_dump($this->getAttribute($this->getAttribute(($context["taxonomy"] ?? null), "taxonomy_map", []), "category", []));
        echo "
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                {{ var_dump(taxonomy.taxonomy_map.category) }}
