...
class __TwigTemplate_32e51f70ecf78d670e9466ea976021ad11da2d62f4d170080589865330bf4dcb extends Twig_Template
{
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            ...
            {% for work in taxonomy.findTaxonomy({'category':listWorks}, 'or').order('folder','asc') %}
                {% set image = work.header.media_order %} {{ vardump(image) }}
