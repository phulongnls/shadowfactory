...
class __TwigTemplate_595340ec62549a06d5ea22e0ec3646f147a0b689f2ecefe443149b3b3d00c532 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        echo "            ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute(($context["taxonomy"] ?? null), "findTaxonomy", [0 => ["category" => ($context["listWorks"] ?? null)]], "method"), "order", [0 => "folder", 1 => "desc"], "method"));
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            ...
            {% endfor %}
            {% for work in taxonomy.findTaxonomy({'category':listWorks}).order('folder','desc') %}
