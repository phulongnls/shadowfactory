...
class __TwigTemplate_d066d8a31ebd0ecc3299f40dabf44c2a023f520628acd080c09f490088b39cf2 extends Twig_Template
{
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                ";
        // line 71
        echo var_dump($this->getAttribute(($context["taxonomy"] ?? null), "findTaxonomy", [0 => "category"], "method"));
        echo "
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                {{ var_dump(taxonomy.findTaxonomy('category')) }}
