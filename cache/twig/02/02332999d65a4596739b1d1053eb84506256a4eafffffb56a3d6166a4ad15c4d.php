...
class __TwigTemplate_8aba480ecd61214e61559c287c1bc0732c4d58344776892a31223db5d7703fcf extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            ...
            echo "<img src=\"";
            echo $this->getAttribute($this->getAttribute($context["work"], "media", []), "url", []);
            echo "\" alt=\"";
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li>{{ var_dump(work.media.path) }}<img src=\"{{ work.media.url }}\" alt=\"{{ work.title }}\"></li>
                {% endfor %}
            </ul>
        </div>
    </div>
