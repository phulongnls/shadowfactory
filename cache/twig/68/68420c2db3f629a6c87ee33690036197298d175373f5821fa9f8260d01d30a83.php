...
class __TwigTemplate_dd856c4d834bc633247ce05be83ede1b197b20e038997e8058871b52314d655b extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            // line 77
            echo "                    <li>";
            echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->vardumpFunc($this->getAttribute($this->getAttribute($context["work"], "media", []), "items", []));
            echo "</li>
                    <li>";
            // line 78
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li>{{ vardump(work.media.items) }}</li>
