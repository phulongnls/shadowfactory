...
class __TwigTemplate_86e211001d3b5d86d9cec956f7c9d8a4d86cf540b80439c7365a904fc554f875 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            // line 77
            echo "                    <li>";
            echo var_dump($this->getAttribute($this->getAttribute($context["work"], "media", []), "path", []));
            echo "<img src=\"";
            echo $this->getAttribute($this->getAttribute($context["work"], "media", []), "getPath", [], "method");
            echo "\" alt=\"";
    ...
    {
        return array (  128 => 79,  115 => 77,  110 => 76,  104 => 75,  101 => 74,  96 => 73,  93 => 72,  91 => 71,  19 => 1,);
    }
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li>{{ var_dump(work.media.path) }}<img src=\"{{ work.media.getPath() }}\" alt=\"{{ work.title }}\"></li>
                {% endfor %}
            </ul>
        </div>
    </div>
