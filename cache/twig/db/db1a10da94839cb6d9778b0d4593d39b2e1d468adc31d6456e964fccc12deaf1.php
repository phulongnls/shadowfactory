...
class __TwigTemplate_6a7d521fe319546b1f5db0ae029c0e28df0aaf6fe24b171240593f110aceb376 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            // line 77
            echo "                    <li><img src=\"";
            echo $this->getAttribute($this->getAttribute($context["work"], "media", []), "filepath", []);
            echo "\" alt=\"";
    ...
    {
        return array (  126 => 79,  115 => 77,  110 => 76,  104 => 75,  101 => 74,  96 => 73,  93 => 72,  91 => 71,  19 => 1,);
    }
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li><img src=\"{{ work.media.filepath }}\" alt=\"{{ work.title }}\"></li>
                {% endfor %}
            </ul>
        </div>
    </div>
