...
class __TwigTemplate_92984feea30071108ca4a41f5202aa9ce005356e5e1b272185cbe79a1c30acad extends Twig_Template
{
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                ";
        // line 71
        echo var_dump($this->getAttribute(($context["taxonomy"] ?? null), "findTaxonomy", [], "method"));
        echo "
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                {{ var_dump(taxonomy.findTaxonomy()) }}
