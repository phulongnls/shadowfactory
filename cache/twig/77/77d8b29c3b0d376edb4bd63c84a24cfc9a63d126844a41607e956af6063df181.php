...
class __TwigTemplate_54e945951dc08d6064624cce58db19e6596a62c949e35785496ff8b16d710791 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                ";
        // line 71
        echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->dump($this->env, $context, $this->getAttribute($this->getAttribute(($context["taxonomylist"] ?? null), "get", [], "method"), "category", [], "array"));
        echo "
                ";
        // line 72
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["taxonomy"] ?? null), "findTaxonomy", [0 => ["category" => $this->getAttribute($this->getAttribute(($context["taxonomylist"] ?? null), "get", [], "method"), "category", [], "array")]], "method"));
    ...
    {
        return array (  108 => 75,  99 => 73,  95 => 72,  91 => 71,  19 => 1,);
    }
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                {{ dump(taxonomylist.get()['category']) }}
                {% for post in taxonomy.findTaxonomy({'category':taxonomylist.get()['category']}) %}
                    <li>{{ post.title }}</li>
                {% endfor %}
            </ul>
        </div>
