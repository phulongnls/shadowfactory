...
class __TwigTemplate_78468e9d97aa16ddfccacb6d6c486611fa97d78269408c8b5bfdc9883ecc6e7b extends Twig_Template
{
    ...
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            ...
            echo "</li>
                    <li>";
            // line 78
            echo var_dump($this->getAttribute($this->getAttribute($this->getAttribute($context["work"], "media", []), ($context["image"] ?? null), [], "array"), "url", []));
            echo "<img src=\"";
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li>{% set image = work.header.media_order %}</li>
                    <li>{{ var_dump(work.media[image].url) }}<img src=\"{{ work.media[image].url }}\" alt=\"{{ work.title }}\"></li>
                {% endfor %}
            </ul>
        </div>
    </div>
