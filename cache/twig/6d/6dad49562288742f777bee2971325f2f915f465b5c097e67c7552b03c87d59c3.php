...
class __TwigTemplate_9217aea9d8cf93eb17d53b5d5d84458c395f09d1a3d962d5184ae7481f9e8240 extends Twig_Template
{
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                {% set works = [\"AR / VR\"] %}
                {{ var_dump(works) }}
                {% for work in taxonomy.findTaxonomy({'category':[\"AR / VR\"]}) %}
                    <li>{{ work.title }}</li>
                {% endfor %}
            </ul>
        </div>
