...
class __TwigTemplate_1d8cb308c0f0176f495d9975b6f5984c349cd2d80c0490dfcea879cc6e1cb623 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            ...
            // line 142
            echo "                ";
            echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->vardumpFunc($this->getAttribute($this->getAttribute($context["work"], "taxonomy", []), "category", [], "array"));
            echo "
                <div class=\"item ";
            // line 143
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            ...
            {% for work in taxonomy.findTaxonomy({'category':listWorks}).order('folder','asc') %}
                ...
                {% endif %}
                {{ vardump(work.taxonomy['category']) }}
