...
class __TwigTemplate_05e7f4702b27ff693fa40fd9cb70680d6f4e4b99749f4024bc369bc6a026c147 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            // line 77
            echo "                    <li>";
            echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->vardumpFunc($this->getAttribute($this->getAttribute($this->getAttribute($context["work"], "media", []), "images", []), 0, [], "array"));
            echo "</li>
                    <li>";
            // line 78
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li>{{ vardump(work.media.images[0]) }}</li>
