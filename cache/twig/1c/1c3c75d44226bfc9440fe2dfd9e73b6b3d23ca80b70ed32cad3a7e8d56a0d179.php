...
class __TwigTemplate_838f2261909074ba4493959d4a556a11accf6d2787dfd5b7c32322ef9d50a60e extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        // line 136
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute(($context["taxonomy"] ?? null), "findTaxonomy", [0 => ["category" => [0 => "AR / VR"]]], "method"), "order", [0 => "folder", 1 => "asc"], "method"));
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            ...
            {% endfor %}
            {{ var_dump(listWorks) }}
            {% for work in taxonomy.findTaxonomy({'category':['AR / VR']}).order('folder','asc') %}
