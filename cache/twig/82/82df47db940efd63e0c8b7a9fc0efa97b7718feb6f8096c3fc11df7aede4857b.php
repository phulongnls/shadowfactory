...
class __TwigTemplate_8b9d9c9044fc9bec74a7862be951d5771ac9b979e26eb9274cc268963f1ecc85 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                {% for page in taxonomy.findTaxonomy({'category':[\"AR / VR\"]}) %}
                    <li>{{ page.title }}</li>
                {% endfor %}
            </ul>
        </div>
