...
class __TwigTemplate_47c3c2a92f81108e1cea7418e7a97d2ee8c8cd38279daf89a03dff304a148be1 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["taxonomy"] ?? null), "findTaxonomy", [0 => "category"], "method"));
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for post in taxonomy.findTaxonomy('category') %}
                    <li>{{ post.title }}</li>
                {% endfor %}
            </ul>
        </div>
