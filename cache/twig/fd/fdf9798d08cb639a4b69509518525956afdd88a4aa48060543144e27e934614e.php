...
class __TwigTemplate_1bc746097de583d2fd0a34540ecf1ba6773fcedfeb62a1b058c2896f283cd76a extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            // line 77
            echo "                    <li>";
            echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->vardumpFunc($this->getAttribute($this->getAttribute($this->getAttribute($context["work"], "media", []), "images", []), "get", [0 => 0], "method"));
            echo "</li>
                    <li>";
            // line 78
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li>{{ vardump(work.media.images.get(0)) }}</li>
