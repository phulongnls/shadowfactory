...
class __TwigTemplate_902e56395ad066c07a46dbcc72badc82ab142af37741db16106ce504aebbaf70 extends Twig_Template
{
    ...
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            ...
            if ($this->getAttribute($this->getAttribute($this->getAttribute($context["work"], "metadata", []), "classtype", [], "array"), "content", [], "array")) {
                // line 136
                echo "                    ";
                echo var_dump($this->getAttribute($this->getAttribute($this->getAttribute($context["work"], "metadata", []), "classtype", [], "array"), "content", [], "array"));
                echo "
                    ";
                // line 137
        ...
        <div class=\"grid-item\">
            ...
            {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                ...
                {% if (work.metadata['classtype']['content']) %}
                    {{ var_dump(work.metadata['classtype']['content']) }}
