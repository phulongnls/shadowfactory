...
class __TwigTemplate_396b98958e7333463e43d1fd0f2ae042c098d1060f2fd9feca3d2dc60c0fde01 extends Twig_Template
{
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                ";
        // line 71
        echo var_dump($this->getAttribute(($context["taxonomy"] ?? null), "taxonomy_map", [], "array"));
        echo "
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                {{ var_dump(taxonomy['taxonomy_map']) }}
