...
class __TwigTemplate_877bf0a2d4757a64a69d8847586c7ec7b07cafbb946878be1b7e27a9880d9302 extends Twig_Template
{
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                ";
        // line 71
        echo var_dump($this->getAttribute(($context["taxonomy"] ?? null), "findTaxonomy", [0 => "category", 1 => "AR/VR"], "method"));
        echo "
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                {{ var_dump(taxonomy.findTaxonomy('category', 'AR/VR')) }}
