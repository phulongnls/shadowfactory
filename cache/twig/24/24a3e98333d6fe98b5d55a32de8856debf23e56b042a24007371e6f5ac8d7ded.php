...
class __TwigTemplate_e64f52396d14c568cb09e5a63bc4e159b5bee396592dbf65386b98e6d6ff726a extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        // line 136
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute(($context["taxonomy"] ?? null), "findTaxonomy", [0 => ["category" => [0 => "AR / VR", 1 => "APPS"]], 1 => "or"], "method"), "order", [0 => "folder", 1 => "asc"], "method"));
...
<script type=\"text/javascript\">
    ...
    {
        return array (  218 => 148,  209 => 145,  203 => 144,  196 => 143,  193 => 142,  190 => 141,  187 => 140,  184 => 139,  181 => 138,  178 => 137,  174 => 136,  169 => 135,  163 => 134,  160 => 133,  155 => 132,  152 => 131,  150 => 130,  19 => 1,);
    }
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            ...
            {% endfor %}
            {{ var_dump(listWorks) }}
            {% for work in taxonomy.findTaxonomy({'category':['AR / VR', 'APPS']}, 'or').order('folder','asc') %}
