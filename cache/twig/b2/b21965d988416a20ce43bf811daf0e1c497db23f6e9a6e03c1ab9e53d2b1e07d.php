...
class __TwigTemplate_beed4e0eef6c2f11a088df7853f30d74b18fe038121961ad2736df320df2d4f4 extends Twig_Template
{
...
<h1>
    ...
    ";
        ...
        // line 22
        echo "    <small>";
        echo twig_escape_filter($this->env, (($this->getAttribute(($context["plugin"] ?? null), "version", [])) ? (("v" . twig_escape_filter($this->env, $this->getAttribute(($context["plugin"] ?? null), "version", [])))) : ("")), "html", null, true);
        echo "</small>
    ";
        // line 23
...
<div class=\"gpm-item-info\">
    ...
    ";
        // line 27
        $this->loadTemplate("partials/plugin-data.html.twig", "partials/plugins-details.html.twig", 27)->display(array_merge($context, ["plugin" => ($context["plugin"] ?? null)]));
        // line 28
        echo "</div>
...
";
        ...
        if (($context["installed"] ?? null)) {
            ...
            // line 32
            echo "    ";
            $this->loadTemplate("partials/blueprints.html.twig", "partials/plugins-details.html.twig", 32)->display(array_merge($context, ["data" => ($context["data"] ?? null), "blueprints" => $this->getAttribute(($context["data"] ?? null), "blueprints", [])]));
            // line 33
            echo "
    ";
            // line 34
...
";
        ...
        // line 59
        $this->loadTemplate("partials/modal-add-package.html.twig", "partials/plugins-details.html.twig", 59)->display(array_merge($context, ["type" => "plugin"]));
        // line 60
        $this->loadTemplate("partials/modal-update-packages.html.twig", "partials/plugins-details.html.twig", 60)->display(array_merge($context, ["type" => "plugin"]));
        // line 61
        $this->loadTemplate("partials/modal-remove-package.html.twig", "partials/plugins-details.html.twig", 61)->display(array_merge($context, ["type" => "plugin", "package" => ($context["plugin"] ?? null)]));
        // line 62
        $this->loadTemplate("partials/modal-reinstall-package.html.twig", "partials/plugins-details.html.twig", 62)->display(array_merge($context, ["type" => "plugin", "package" => ($context["plugin"] ?? null)]));
    }
...
", "partials/plugins-details.html.twig", "/var/www/html/shadowfactory/user/plugins/admin/themes/grav/templates/partials/plugins-details.html.twig");
    }
}
