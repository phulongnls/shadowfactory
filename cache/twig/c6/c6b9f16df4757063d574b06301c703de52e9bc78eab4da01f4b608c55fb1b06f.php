...
class __TwigTemplate_b736598cf9487328e8319294f18be553147b2d2a1fc47e4ca40d63aa36f8eb7b extends Twig_Template
{
...
<script type=\"text/javascript\">
    ...
    \$('.list-works .filter').on( 'click', 'button', function() {
        ...
        \$('.list-works .grid-item .item').removeAttribute('style');
    });
</script>";
    }
