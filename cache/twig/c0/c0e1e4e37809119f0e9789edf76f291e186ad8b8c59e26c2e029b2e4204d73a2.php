...
class __TwigTemplate_7dd8b13733f5e7ac6950480d94eaacd2c852b6065bc5e28f588302a74b14fb0d extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            // line 77
            echo "                    <li>";
            echo var_dump($this->getAttribute($this->getAttribute($context["work"], "media", []), "url", []));
            echo "<img src=\"";
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li>{{ var_dump(work.media.url) }}<img src=\"{{ work.media.path }}\" alt=\"{{ work.title }}\"></li>
                {% endfor %}
            </ul>
        </div>
    </div>
