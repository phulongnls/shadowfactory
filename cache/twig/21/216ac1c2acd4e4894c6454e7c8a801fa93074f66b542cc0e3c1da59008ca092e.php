...
class __TwigTemplate_ed63cf0ec4d209368d4e4ea92aa7004e6702be9ba8975f9dce88d97e89eb68e1 extends Twig_Template
{
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                ";
        // line 71
        echo var_dump($this->getAttribute(($context["taxonomylist"] ?? null), "get", [0 => "tawewewg"], "method"));
        echo "
            </ul>
        </div>
    </div>
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                {{ var_dump(taxonomylist.get('tawewewg')) }}
            </ul>
        </div>
    </div>
