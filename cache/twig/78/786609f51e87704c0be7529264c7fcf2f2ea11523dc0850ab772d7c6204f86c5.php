...
class __TwigTemplate_cec55e9fe14f946d5fd9e44bde30db8dcb28b0311953cd349051e0acf34410db extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            // line 77
            echo "                    <li>";
            echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->vardumpFunc($this->getAttribute($this->getAttribute($context["work"], "media", []), "filenames", []));
            echo "</li>
                    <li>";
            // line 78
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li>{{ vardump(work.media.filenames) }}</li>
