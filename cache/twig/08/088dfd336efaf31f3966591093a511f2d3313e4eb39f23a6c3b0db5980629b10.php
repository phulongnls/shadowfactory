...
class __TwigTemplate_09d7c801d149e2e03d7d3f936535bb6df46ddff16a2bd63e1c08b448b2ea2506 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            ...
            echo " ";
            echo $this->getAttribute($context["work"], "taxonomy", []);
            echo "\">
                    <img src=\"";
            // line 143
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            ...
            {% for work in taxonomy.findTaxonomy({'category':listWorks}).order('folder','asc') %}
                ...
                {% endif %}
                <div class=\"item {{ classSize }} {{work.taxonomy}}\">
