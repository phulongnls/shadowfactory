...
class __TwigTemplate_bbc559194c1d91f874710ee9715add50832e62e2682400d5711b4f27cfe466a2 extends Twig_Template
{
    ...
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                ";
        // line 71
        echo $this->getAttribute($this->getAttribute($this->getAttribute(($context["page"] ?? null), "metadata", []), "arr", []), "content", []);
        echo "
                ";
        // line 72
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["taxonomy"] ?? null), "findTaxonomy", [0 => ["category" => $this->getAttribute($this->getAttribute($this->getAttribute(($context["page"] ?? null), "metadata", []), "arr", []), "content", [])]], "method"));
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            <ul>
                {{ page.metadata.arr.content }}
                {% for post in taxonomy.findTaxonomy({'category':page.metadata.arr.content}) %}
                    <li>{{ post.title }}</li>
                {% endfor %}
            </ul>
        </div>
