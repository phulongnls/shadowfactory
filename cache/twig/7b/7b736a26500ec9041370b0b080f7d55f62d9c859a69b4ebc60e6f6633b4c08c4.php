...
class __TwigTemplate_ad39a465dd245dc77c34f1cabbe20b6301d4b50423506822e499cef9f76828d2 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["work"]) {
            // line 77
            echo "                    <li>";
            echo var_dump($this->getAttribute($this->getAttribute($this->getAttribute($context["work"], "media", []), "images", []), 1, [], "array"));
            echo "<img src=\"";
        ...
        <div class=\"grid-item\">
            <ul>
                ...
                {% for work in taxonomy.findTaxonomy({'category':listWorks}) %}
                    <li>{{ var_dump(work.media.images[1]) }}<img src=\"{{ work.media.path }}\" alt=\"{{ work.title }}\"></li>
                {% endfor %}
            </ul>
        </div>
    </div>
