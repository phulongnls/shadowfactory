...
class __TwigTemplate_0d6c3050afb5cc02f7aa0ac47cafe4645e9ca1189104c665b5a93cadffdbbd3a extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        // line 136
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute(($context["taxonomy"] ?? null), "findTaxonomy", [0 => ["category" => [0 => "AR / VR", 1 => "APPS"]]], "method"), "order", [0 => "folder", 1 => "asc"], "method"));
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        ...
        <div class=\"grid-item\">
            ...
            {% endfor %}
            {{ var_dump(listWorks) }}
            {% for work in taxonomy.findTaxonomy({'category':['AR / VR', 'APPS']}).order('folder','asc') %}
