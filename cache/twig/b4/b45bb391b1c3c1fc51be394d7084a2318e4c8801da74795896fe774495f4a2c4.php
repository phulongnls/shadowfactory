...
class __TwigTemplate_a16f18c4512e061c17b6d156d83b24adf7e251df358f81e2de993f2651280ca3 extends Twig_Template
{
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        <div class=\"filter\">
            ...
            <button data-filter=\".";
        // line 122
        echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->inflectorFilter("camel", "AR / VR");
        echo "\">AR / VR</button>
...
<script type=\"text/javascript\">
    ...
    {
        return array (  235 => 151,  226 => 148,  220 => 147,  209 => 146,  206 => 145,  203 => 144,  200 => 143,  197 => 142,  194 => 141,  191 => 140,  188 => 139,  185 => 138,  182 => 137,  179 => 136,  176 => 135,  171 => 134,  165 => 133,  162 => 132,  157 => 131,  154 => 130,  152 => 129,  142 => 122,  19 => 1,);
    }
...
<div class=\"outer-grid\">
    <div class=\"list-works grid\">
        <div class=\"filter\">
            <button class=\"active\" data-filter=\"*\">ALL</button>
            <button data-filter=\".{{ 'AR / VR'|camelize }}\">AR / VR</button>
            <button data-filter=\".APPS\">APPS</button>
            <button data-filter=\".INTERACTIVE\">INTERACTIVE</button>
            <button>VIDEO</button>
        </div>
        <div class=\"grid-item\">
            ...
            {% for work in taxonomy.findTaxonomy({'category':listWorks}, 'or').order('folder','asc') %}
                ...
                {% endif %}
                <div class=\"item {{ classSize }} {{ work.taxonomy['category'][0] }}\" data-all=\"{{ classSize }}\" data-type=\"{{ classSize1 }}\">
